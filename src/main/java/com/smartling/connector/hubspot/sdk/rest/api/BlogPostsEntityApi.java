...
{
    @RequestLine("GET /blogs/v3/blog-posts?archived={archived}&campaign={campaign}&content_group_id={content_group_id}&name__icontains={name}&slug={slug}&state={state}&offset={offset}&limit={limit}&order_by={order_by}&language={language}&property=" + BlogPostDetail.FIELDS)
